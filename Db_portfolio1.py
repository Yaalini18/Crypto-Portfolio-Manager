# m2p2
# Db_portfolio.py
# Create two tables for portfolio and portfolio_assets to store currencies, weights,, returns, risk, metrics
...
db_path = r"C:\Users\Hp\OneDrive\Desktop\crypto_upload\Db_portfolio1.db"
...
assets = [("Bitcoin", 0.6), ("Ethereum", 0.4)]
